...
var G__41281 = o;
goog.object.set(G__41281,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__41299__delegate = function (args){
...
while (G__41300__i < G__41300__a.length) {G__41300__a[G__41300__i] = arguments[G__41300__i + 0]; ++G__41300__i;}
  args = new cljs.core.IndexedSeq(G__41300__a,0,null);
} 
...
var args = cljs.core.seq(arglist__41301);
...
var G__41282 = o;
goog.object.set(G__41282,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__41302__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__41303__i < G__41303__a.length) {G__41303__a[G__41303__i] = arguments[G__41303__i + 0]; ++G__41303__i;}
  args = new cljs.core.IndexedSeq(G__41303__a,0,null);
} 
return G__41302__delegate.call(this,args);};
G__41302.cljs$lang$maxFixedArity = 0;
G__41302.cljs$lang$applyTo = (function (arglist__41304){
var args = cljs.core.seq(arglist__41304);
return G__41302__delegate(args);
});
...
var G__41283 = props;
var G__41283__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41283,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__41283);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41283__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__41284 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41284,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__41284;
}
})(),id_class);
...
var G__41285 = (cljs.core.count(argv) - first_child);
switch (G__41285) {
case (0):
...
var vec__41286 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41286,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41286,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41286,(2),null);
...
var temp__5757__auto___41318 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___41318 == null)){
} else {
var key_41319 = temp__5757__auto___41318;
(jsprops.key = key_41319);
}
...
var temp__5757__auto___41323 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___41323 == null)){
} else {
var key_41326 = temp__5757__auto___41323;
(jsprops.key = key_41326);
}
...
var temp__5757__auto___41329 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___41329 == null)){
} else {
var key_41330 = temp__5757__auto___41329;
(jsprops.key = key_41330);
}
...
var temp__5757__auto___41336 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___41336 == null)){
} else {
var key_41337 = temp__5757__auto___41336;
(jsprops.key = key_41337);
}
...
var temp__5757__auto___41339 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___41339 == null)){
} else {
var key_41344 = temp__5757__auto___41339;
(jsprops.key = key_41344);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41289_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__41289_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__41290 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41290,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41290,(1),null);
...
break;
default:
var G__41348 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__41349 = compiler;
v = G__41348;
compiler = G__41349;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template41296 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template41296 = (function (opts,id,fn_to_element,parse_fn,meta41297){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template41296.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41298,meta41297__$1){
var self__ = this;
var _41298__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template41296(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta41297__$1));
}));

(reagent.impl.template.t_reagent$impl$template41296.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41298){
var self__ = this;
var _41298__$1 = this;
return self__.meta41297;
}));

(reagent.impl.template.t_reagent$impl$template41296.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template41296.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template41296.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template41296.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template41296.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template41296.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta41297","meta41297",1077008072,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template41296.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template41296.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template41296");

(reagent.impl.template.t_reagent$impl$template41296.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template41296");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template41296.
 */
reagent.impl.template.__GT_t_reagent$impl$template41296 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template41296(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta41297){
return (new reagent.impl.template.t_reagent$impl$template41296(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta41297));
});

}

return (new reagent.impl.template.t_reagent$impl$template41296(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
