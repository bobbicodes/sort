...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__41261){
var map__41262 = p__41261;
var map__41262__$1 = cljs.core.__destructure_map(map__41262);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41262__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__41270_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__41270_SHARP_);
}));
