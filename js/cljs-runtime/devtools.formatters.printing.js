...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq33312){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33313,G__33314,seq33312__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__33328_SHARP_){
return (!((cljs.core.meta(p1__33328_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33340__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e33342){var _e__30280__auto__ = e33342;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e33344){var _e__30280__auto__ = e33344;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__33355 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__33356 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__33356);

try{var map__33357 = opts;
var map__33357__$1 = cljs.core.__destructure_map(map__33357);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33357__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__33355);
}});
...
var temp__5751__auto___33436 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___33436)){
var managed_print_level_33437 = temp__5751__auto___33436;
var _STAR_print_level_STAR__orig_val__33370_33438 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__33371_33439 = managed_print_level_33437;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__33371_33439);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__33361_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__33361_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__33370_33438);
}} else {
job_fn();
}
