...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_33794 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_33794(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_33798 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_33798(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_33799 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_33799(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_33800 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_33800(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_33801 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_33801(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_33804 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_33804(reader);
}
});
...
var G__33814 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__33815 = s.append(c);
c = G__33814;
s = G__33815;
continue;
}
