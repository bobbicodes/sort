...
var i_34231 = (self__.level + (1));
while(true){
if((i_34231 <= (new_level + (1)))){
(update[i_34231] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_34236 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_34236[i]));
} else {
x__$2.forward.push((((i < links_34236.length))?(links_34236[i]):null));
}

if((i < links_34236.length)){
(links_34236[i] = x__$2);
} else {
links_34236.push(x__$2);
}
...
var i_34238 = (0);
while(true){
if((i_34238 <= self__.level)){
var links_34249 = (update[i_34238]).forward;
if((x__$1 === (((i_34238 < links_34249.length))?(links_34249[i_34238]):null))){
(links_34249[i_34238] = (x__$1.forward[i_34238]));

var G__34252 = (i_34238 + (1));
i_34238 = G__34252;
continue;
} else {
var G__34253 = (i_34238 + (1));
i_34238 = G__34253;
continue;
}
} else {
...
var G__34262 = nx;
var G__34263 = (level__$1 - (1));
x = G__34262;
level__$1 = G__34263;
continue;
} else {
var G__34270 = x;
var G__34271 = (level__$1 - (1));
x = G__34270;
level__$1 = G__34271;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__34279 = nx;
var G__34280 = (level__$1 - (1));
x = G__34279;
level__$1 = G__34280;
continue;
} else {
var G__34282 = x;
var G__34283 = (level__$1 - (1));
x = G__34282;
level__$1 = G__34283;
continue;
}
