...
var o32832 = temp__5751__auto__;
var temp__5751__auto____$1 = (o32832["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o32833 = temp__5751__auto____$1;
return (o32833["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30272__auto__ = f;
return (o__30272__auto__["toString"]).call(o__30272__auto__);
} else {
return "";
}
}catch (e32840){var _ = e32840;
return "";
}});
...
try{var o__30272__auto___33057 = t;
(o__30272__auto___33057["cljs$lang$ctorPrWriter"]).call(o__30272__auto___33057,t,writer);
}catch (e32849){var __33058 = e32849;
}
...
var char_code = (function (){var o__30272__auto__ = (new String(char$));
return (o__30272__auto__["charCodeAt"]).call(o__30272__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30272__auto__ = String;
return (o__30272__auto__["fromCharCode"]).call(o__30272__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32860 = num_code;
switch (G__32860) {
case (1):
return (185);
...
var o__30272__auto__ = String;
return (o__30272__auto__["fromCharCode"]).call(o__30272__auto__,superscript_code);
});
/**
...
}catch (e32893){var _e__30280__auto__ = e32893;
return false;
}})())){
...
var vec__32894 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32894,(0),null);
...
var len__4829__auto___33062 = arguments.length;
var i__4830__auto___33063 = (0);
while(true){
if((i__4830__auto___33063 < len__4829__auto___33062)){
args__4835__auto__.push((arguments[i__4830__auto___33063]));

var G__33064 = (i__4830__auto___33063 + (1));
i__4830__auto___33063 = G__33064;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32909){
var vec__32910 = p__32909;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32910,(0),null);
...
var G__33065 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__33066 = cljs.core.butlast(remaining_tokens);
name_tokens = G__33065;
remaining_tokens = G__33066;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32902){
var G__32903 = cljs.core.first(seq32902);
var seq32902__$1 = cljs.core.next(seq32902);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32903,seq32902__$1);
}));
...
var vec__32948 = cljs.core.split_with((function (p1__32947_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__32947_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32948,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32948,(1),null);
...
var vec__32955 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32955,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32955,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__33068 = cljs.core.rest(remaining_tokens);
var G__33069 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__33068;
name_tokens = G__33069;
continue;
} else {
...
var vec__32960 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32960,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32960,(1),null);
var vec__32963 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32963,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32963,(1),null);
var vec__32966 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32966,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32966,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32966,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32966,(3),null);
...
var vec__32979 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32979,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32979,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32979,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32979,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32979,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32979,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__32982 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32982,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32982,(1),null);
var vec__32987 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32987,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32987,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__32993 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__32993) : devtools.munging.parse_fn_info_deep.call(null,G__32993));
})()));
}
} else {
return fn_info;
...
var G__33088 = (arity + (1));
var G__33089 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33002){
var vec__33003 = p__33002;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33003,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33003,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33019_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__33019_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33020_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__33020_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___33111 = arguments.length;
var i__4830__auto___33112 = (0);
while(true){
if((i__4830__auto___33112 < len__4829__auto___33111)){
args__4835__auto__.push((arguments[i__4830__auto___33112]));

var G__33113 = (i__4830__auto___33112 + (1));
i__4830__auto___33112 = G__33113;
continue;
} else {
}
break;
...
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33024,(0),null);
...
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33022,seq33021__$1);
}));
...
var map__33038 = options;
var map__33038__$1 = cljs.core.__destructure_map(map__33038);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33038__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33038__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33038__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33038__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33039 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33039,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33039,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33039,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33039,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33039,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33039,(5),null);
...
var o__30272__auto__ = f;
return (o__30272__auto__["getBasis"]).call(o__30272__auto__);
});
/**
...
}catch (e33042){var _e__30280__auto__ = e33042;
...
var G__33125 = (obj[cljs.core.first(path)]);
var G__33126 = cljs.core.rest(path);
obj = G__33125;
path = G__33126;
continue;
} else {
...
var _STAR_ = (function (accum,p__33043){
var vec__33044 = p__33043;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33044,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33044,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__33048){
var vec__33049 = p__33048;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33049,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33049,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33049,(2),null);
...
var post_process = (function (p__33053){
var vec__33054 = p__33053;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33054,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33054,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33052_SHARP_){
return (obj[cljs.core.first(p1__33052_SHARP_)]);
}),sorted_matches);
